...
public final class ElementoConstant {
    ...
    {"Se", "NoMetal", "OtroNoMetal", "Solido", new int[]{-2, 2, 4, 6}},
    {"S", "NoMetal", "OtroNoMetal", "Solido", new int[]{-2, 2, 4, 6}},
    ...
    {"Ar", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
    {"He", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
    {"Kr", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
    {"Ne", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
    {"Rn", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
    {"Xe", "NoMetal", "GasNoble", "Gaseoso", new int[]{0}},
